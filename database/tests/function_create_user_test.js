...
async function main(){
	...
	try{
		await add_funs.delete_user(client, 'test_add_user', 'test_add_hash', 'test_add_email@fake.com', 'test_add_first', 'test_add_last', 'test_add_salt');
	...
	try{
		const ret_id = await add_funs.new_user(client, 'test_add_user', 'test_add_hash', 'test_add_email@fake.com', 'test_add_first', 'test_add_last', 'test_add_salt');
	...
	try{
		const ret_id_2 = await add_funs.new_user(client, 'test_add_user', 'test_add_hash', 'test_add_email@fake.com', 'test_add_first', 'test_add_last', 'test_add_salt');
