        ...
        return (
            <div id="user-account">
                    <div className="images">
                        ...
                        <div className="image">
                            <img src={sprite_five} className="profile-picture-selection" alt="" onClick={this.handleClick5}/>
                        </div>
                        <div className="image">
                            <img src={sprite_six} className="profile-picture-selection" alt="" onClick={this.handleClick6}/>
                        </div>
                    </div>
